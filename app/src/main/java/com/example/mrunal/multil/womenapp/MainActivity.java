        ...
        txtSpeechMap.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before,
                ...
                if (abc.equals("Map") || abc.equals("map") || abc.equals("Maps") || abc.equals("maps")) {
                    //do your work here
                    Intent i = new Intent(MainActivity.this,ESeva.class);
                    startActivity(i);
    ...
    private void alert() {
        ...
        adb.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                playingaudio("morningmessage1.mp3");
...
//            calender.set(Calendar.MINUTE, 36);  //pass min which you have select
